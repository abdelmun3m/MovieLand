package com.abdelmun3m.movie_land.MoviesProvider;
...
public class FavoriteMoviesDbHelper extends SQLiteOpenHelper {
    ...
    public static final String MOVIE_DB_NAME ="MOVIES_LAND_DB";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String CREATE_FAVORITE_MOVIE_TABLE ="CREATE TABLE "
                ...
                + MoviesContract.FavoriteMoviesEntity.COLUMN_BACKDROP + " TEXT NOT NULL"+","
